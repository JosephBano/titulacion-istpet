    ...
    switch (paso) {
      case 1:
        return {
          ...
          descripcion:
            'Registro de la solicitud formal de titulación académica dentro del período de la cohorte activa.',
          ...
          proximoPaso:
            'Revisión y validación de requisitos por parte de docentes revisores y secretaría.',
      ...
      case 2:
        return {
          ...
          descripcion:
            'Revisión académica de certificados (Inglés, Vinculación, Prácticas Preprofesionales, Financiero).',
      ...
      case 4:
        return {
          ...
          descripcion:
            'Sustentación pública de proyecto de investigación o rendición del Examen Complexivo ante tribunal.',
          queSignifica:
            this.etapaActual() >= 4
          ...
          accionEstudiante:
            'Presentarse en la fecha y hora designada para su sustentación o examen.',
      ...
      default:
        return {
          ...
          descripcion:
            'Incorporación formal y registro del título profesional en el sistema ISTPET y SENESCYT.',
          queSignifica:
            this.etapaActual() >= 5
          ...
          proximoPaso:
            'Registro oficial de su título en la Secretaría de Educación Superior (SENESCYT).',
