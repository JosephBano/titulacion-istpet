# Arquitectura Frontend Angular 19 Standalone y Signals — Sistema Titán

## 1. Principios de Arquitectura Frontend

El cliente web de Titán está desarrollado en **Angular 19** aprovechando las características modernas del framework.
...
La configuración global de Angular 19 se realiza sin `AppModule`, utilizando proveedores funcionales:
