# Sistema de Diseño Fluent Design 2 e Identidad ISTPET — Sistema Titulación ISTPET

## 1. Estándar Visual Microsoft Fluent Design 2

El cliente web de Titulación ISTPET implementa el sistema de diseño **Microsoft Fluent Design 2**, adaptado con la paleta de colores oficiales e identidad corporativa del **Instituto Tecnológico Superior Traversari (ISTPET)**.
