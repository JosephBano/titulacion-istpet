# Patrones de Diseño y Convenciones de Código — Sistema Titán
...
El registro de servicios de infraestructura y acceso a datos se encapsula en la clase de extensión `DependencyInjection.cs` de `Titan.Infrastructure`:
