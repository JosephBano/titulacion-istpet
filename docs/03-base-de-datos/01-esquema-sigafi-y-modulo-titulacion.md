# Esquema Relacional SIGAFI y Módulo Titulación — Sistema Titulación ISTPET

## 1. Integración de la Base de Datos (`sigafi_es`)

El sistema Titulación ISTPET opera directamente sobre la base de datos MySQL **`sigafi_es`** del Instituto Tecnológico Superior Traversari. Las tablas del sistema se dividen en dos grupos:
