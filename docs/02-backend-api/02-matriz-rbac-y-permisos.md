# Matriz de Autorización RBAC y Atributo HasPermission — Sistema Titán

## 1. Modelo de Autorización RBAC (Role-Based Access Control)

El sistema Titán implementa un esquema de control de acceso basado en roles y permisos parametrizables por módulo y operación.
