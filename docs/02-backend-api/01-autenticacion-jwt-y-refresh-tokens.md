# Autenticación JWT y Rotación de Refresh Tokens — Sistema Titán

## 1. Mecanismo de Autenticación

El sistema Titán utiliza JSON Web Tokens (JWT) firmados mediante la clave secreta institucional con el algoritmo **HMAC-SHA256 (HS256)**.
...
- **Autorización:** `[Authorize]`
- **Parámetros de Consulta:** `systemCode` (opcional, por defecto `"TITAN"`).
