# Middleware Global y Manejo de Errores ProblemDetails — Sistema Titán

## 1. Estándar de Respuesta de Error (RFC 7807)

El backend de Titán captura todas las excepciones no controladas a nivel de middleware global, evitando la fuga de información sensible o trazas de pila desprotegidas en entornos de producción.
