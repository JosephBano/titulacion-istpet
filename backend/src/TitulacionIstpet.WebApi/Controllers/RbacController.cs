...
public class RbacController : ControllerBase
{
    ...
    /// </summary>
    [HttpGet("sistemas")]
    public async Task<ActionResult<List<RbacSistemaDto>>> GetSistemas(CancellationToken cancellationToken)
    {
    ...
    public async Task<ActionResult<List<RbacModuloDto>>> GetModulosBySistema(int idSistema, CancellationToken cancellationToken)
    {
    ...
    /// </summary>
    [HttpGet("roles")]
    public async Task<ActionResult<List<RbacRolDto>>> GetRoles(CancellationToken cancellationToken)
    {
    ...
    /// <summary>
    /// Asignar una operación de un módulo a un rol
    /// </summary>
