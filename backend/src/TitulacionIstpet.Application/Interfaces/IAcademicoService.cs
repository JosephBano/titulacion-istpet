...
public interface IAcademicoService
{
    ...
    Task<IEnumerable<PeriodoResponseDto>> GetPeriodosVigentesAsync(bool soloActivos = false, bool soloInstituto = true, bool soloVigentesOFuturos = false, CancellationToken cancellationToken = default);
